...
<div id="container">
	...
	<section id="c_1" class="paragraph">
		...
		<div class="news_l list">
			<?php
			        $args = array (
			        'category__in' => array('18'), // カテゴリのIDを記入する
	...
	<section id="c_2" class="paragraph">
		...
		<div class="news_l list">
			<?php
			        $args = array (
			        'category__in' => array('28'), // カテゴリのIDを記入する
			        'order' => 'DESC', // 記事の並び順 昇順（ASC）、降順（DESC）
			        'paged' => $paged,
		...
		<div id="view_a">
			<a href="<?php echo home_url() ?>/category/en/news_en/pastconcerts_en/">
